...
from dqn_phi03 import dqn_phi

import train_agent_async01 as train_agent_async
import net05 as net
import a3c01 as a3c
...
#        model = A3CFF(n_actions)
    ...
    agent = a3c.A3C(model, opt, gpu=args.gpu, t_max=args.t_max, gamma=0.99, beta=args.beta, phi=dqn_phi)
    if args.load:
...
#        experiments.train_agent_async(
        train_agent_async.train_agent_async(
            agent=agent,
            outdir=args.outdir,
