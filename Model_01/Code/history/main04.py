...
import train_agent02 as train_agent
import net03 as net
import dqn01 as dqn
...
def parse_arch(arch, n_actions, activation):
    if arch == 'nature':
        ...
        return DiscreteActionValue(net.SiS(n_actions))
    else:
...
def main():
    ...
    parser.add_argument('--arch', type=str, default='sis', choices=['nature', 'nips', 'dueling', 'sis'])
    parser.add_argument('--steps', type=int, default=10 ** 7)
    parser.add_argument('--replay-start-size', type=int, default=5 * 10 ** 4)
    parser.add_argument('--target-update-frequency', type=int, default=10 ** 4)
    ...
    parser.add_argument('--agent', type=str, default='DQN', choices=['DQN', 'DoubleDQN', 'PAL'])
