...
def main():
    ...
    parser.add_argument('--rom', type=str, default='space_invaders')
    parser.add_argument('--seed', type=int, default=None)
    parser.add_argument('--gpu', type=int, default=0)
    parser.add_argument('--input_action', action='store_true', default=False)
...
#        model.to_cpu()
    ...
    def make_agent(process_idx, a2c):
        agent = a3c.A3C(model, opt, a2c=a2c, gpu=args.gpu, t_max=args.t_max, gamma=0.99, beta=args.beta, phi=phi)
